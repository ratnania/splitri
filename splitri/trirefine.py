...
##    list_tri = range(0, triang_ref.triangles.shape[0])
#    for T_id in list_tri:
##        print "Triangle ", T_id
#        B_coeff[triang_ref.triangles[T_id]] = T_id
#        x_ref = triang_ref.x[triang_ref.triangles[T_id]]
#        y_ref = triang_ref.y[triang_ref.triangles[T_id]]
##        print zip(x_ref, y_ref)

##    T_id = 50
#    T_id = 51
#    B_coeff[triang_ref.triangles[T_id]] = 1.0
#    x_ref = triang_ref.x[triang_ref.triangles[T_id]]
#    y_ref = triang_ref.y[triang_ref.triangles[T_id]]
