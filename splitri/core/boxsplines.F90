...
CONTAINS      
        ...
        SUBROUTINE BS3DM(L,M,N,A_SIZE,A,B,BSIZE1,BSIZE2)                    
...
!        SUBROUTINE BS4DM(K,L,M,N,MY_SIZE,A,B,BSIZE1,BSIZE2)                  
...
!        IMPLICIT NONE
!        INTEGER :: K,L,M,N,BSIZE1,BSIZE2,MY_SIZE                            
!        INTEGER, DIMENSION(0:MY_SIZE,0:MY_SIZE) :: A,B
